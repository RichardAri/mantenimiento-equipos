...
const ListaTiendas = () => {
  ...
  return (
    <div className="tiendas-container">
      ...
      <ModalAñadirTienda isOpen={modalAñadirAbierto} onRequestClose={cerrarModalAñadir} />
      <ModalEditarTienda isOpen={modalEditarAbierto} onRequestClose={cerrarModalEditar} tienda={tiendaSeleccionada} />
    </div>
  );
};
