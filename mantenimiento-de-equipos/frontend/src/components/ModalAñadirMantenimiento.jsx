...
const ModalAñadirMantenimiento = ({ isOpen, onRequestClose, onSave, equipoId, tiendaId }) => {
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onRequestClose} className="modal">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <textarea value={descripcionEquipo} onChange={(e) => setDescripcionEquipo(e.target.value)} />
